...
const StartPage = () => {
  ...
  const [isMarkerLoad, setIsMarkerLoad] = useState(false);
  //넘겨줄 데이터 선언
  ...
  useEffect(() => {
    ...
    markerInit();
    setIsMarkerLoad(true);
  }, [mapIm]);
  useEffect(() => {
    const markerUpdate = (lat, lon) => {
      if (isMarkerLoad) {
        const updateMarker = new Tmapv2.Marker({
          position: new Tmapv2.LatLng(lat, lon),
          icon: 'data:image/png;base64,',
        }).setMap(mapIm);
        //마커를 지워야하는데 자꾸 객체가 안만들어져ㅑ서 못지움
  ...
  }, [latitude, longitude, marker, mapIm]);
